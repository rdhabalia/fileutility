 ...
 *
 */
public class CustomStringTokenizer implements java.util.Enumeration<String>, java.util.Iterator<String> {
	 ...
	 * @since ostermillerutils 1.00.00
	 */
	public CustomStringTokenizer(String text, String nontokenDelims, String tokenDelims){
	 ...
	 * @since ostermillerutils 1.00.00
	 */
	public CustomStringTokenizer(String text, String nontokenDelims, String tokenDelims, boolean returnEmptyTokens){
	 ...
	 * @since ostermillerutils 1.00.00
	 */
	public CustomStringTokenizer(String text, String delims, boolean delimsAreTokens){
	 ...
	 * @since ostermillerutils 1.00.00
	 */
	public CustomStringTokenizer(String text, String nontokenDelims){
	 ...
	 * @since ostermillerutils 1.00.00
	 */
	public CustomStringTokenizer(String text){
		this(text, " \t\n\r\f", null);
	}
